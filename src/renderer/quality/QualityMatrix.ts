...
const estimateClusterCount = (config: RendererConfig): number => {
...
export const getQualitySummary = (preset: QualityPreset): QualitySummary => {
...
export const buildQualityMatrix = (): QualitySummary[] => {
