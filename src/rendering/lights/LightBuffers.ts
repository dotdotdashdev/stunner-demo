...
function writeVec3(target: Float32Array, offset: number, value: Vec3): void {
  target[offset] = value[0]
  target[offset + 1] = value[1]
  target[offset + 2] = value[2]
}

function normalizeOrDefault(direction: Vec3): Vec3 {
...
export function packLights(lights: RenderLight[]): PackedLightBuffers {
